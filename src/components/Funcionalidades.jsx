    ...
    <section id="funcionalidades" className="bg-[#2B1B14] text-white px-6 py-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-wrap gap-6 items-start">
          <div className="bg-[#FFF3E8] text-[#2B1B14] rounded-2xl p-7 w-full md:w-[45%]">
          ...
          <div className="bg-[#F6B73C] text-[#2B1B14] rounded-2xl p-7 w-full md:w-[40%] md:mt-12">
          ...
          <div className="bg-[#E86A33] rounded-2xl p-7 w-full md:w-[55%] md:ml-20">
