      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          <div className="flex-1">
            <div className="bg-[#FFF8F1] rounded-[2rem] p-7 shadow-md">
            ...
            <div className="bg-[#E86A33] text-white rounded-[2rem] p-7 shadow-md mt-6 md:ml-10">
            ...
            <div className="bg-[#AEBB9F] text-[#2B1B14] rounded-[2rem] p-7 shadow-md mt-6">
          ...
          <div className="flex-1 md:mt-10">
            <div className="bg-[#2B1B14] text-white rounded-[2rem] p-7 shadow-md">
              <h3 className="text-xl font-bold">Lucas</h3>
              <p className="text-stone-300 mt-3">A experiência é simples, rápida e muito prática.</p>
            </div>

            <div className="bg-[#FFF8F1] rounded-[2rem] p-7 shadow-md mt-6 md:mr-10">
            ...
            <div className="bg-[#6B321F] text-white rounded-[2rem] p-7 shadow-md mt-6">
